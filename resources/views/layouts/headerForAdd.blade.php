                    ...
                    {{--  languages flags --}}
                       ...
                       {{-- profile pictrue --}}
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-inline-flex" href=""><img alt="" src="{{ Auth::user()->avatar }}"></a>
                                <div class="dropdown-menu">
									...
									<a class="dropdown-item" href="{{  route('user')  }}"><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href="{{  route('user.edit' , Auth::id())  }}"><i class="bx bx-cog"></i> Edit Profile</a>
									<a class="dropdown-item" href="{{  route('user.messages')  }}"><i class="bx bxs-inbox"></i>Inbox</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a>
									<a class="dropdown-item" href=" {{ route('user.edit' , Auth::user()) }} "><i class="bx bx-slider-alt"></i> Account Settings</a>
